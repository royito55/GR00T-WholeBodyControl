...
- Control loop entry point: gr00t_wbc/control/main/teleop/run_g1_control_loop.py
- Teleop loop entry point: gr00t_wbc/control/main/teleop/run_teleop_policy_loop.py
- WBC policy wiring: gr00t_wbc/control/policy/wbc_policy_factory.py
- Whole-body policy (upper + lower): gr00t_wbc/control/policy/g1_decoupled_whole_body_policy.py
- Lower-body ONNX policy: gr00t_wbc/control/policy/g1_gear_wbc_policy.py
- G1 environment & safety: gr00t_wbc/control/envs/g1/g1_env.py
- Teleop policy (IK + streamers): gr00t_wbc/control/policy/teleop_policy.py
- Teleop device streamers: gr00t_wbc/control/teleop/teleop_streamer.py
- Data export to LeRobot: gr00t_wbc/data/exporter.py
- Deployment orchestration: scripts/deploy_g1.py
- Inference helpers (ZMQ): gr00t_wbc/control/utils/service.py
